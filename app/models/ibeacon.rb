class Ibeacon < ApplicationRecord
    ...
    def classify_exercise(x,y,z)
        ...
        # curl
        x1 = [[-812.0,-328.0,-625.0,-359.0,15.0,-687.0,-296.0,-484.0,-453.0,-125.0,-625.0,-406.0,-359.0,-437.0,-343.0,343.0,62.0,343.0].collect { |n| n / 548.0 }]
        y1 = [[-718.0, -1718.0, -1328.0, -93.0, -1187.0, -453.0, -1562.0, -1218.0, -109.0, -1281.0, -453.0, -1593.0, -1187.0, -343.0, -1093.0, 1312.0, -1046.0, -953.0].collect { |n| n / 548.0 }]
        z1 = [[203.0, 62.0, 156.0, 109.0, 125.0, 218.0, 156.0, 78.0, 109.0, 109.0, 171.0, 109.0, 187.0, 140.0, 140.0, 343.0, 62.0, 31.0].collect { |n| n / 548.0 }]


        # press 
        x2 = [[-484.0,-968.0,-359.0,-250.0,-515.0,-1500.0,-1031.0,-828.0,-968.0,-750.0,-375.0,-437.0,-875.0,640.0,671.0].collect { |n| n / 548.0 }]
        y2 = [[-515.0, -390.0, -234.0, -125.0, -15.0, -312.0, -156.0, -31.0, 0.0, -31.0, -125.0, 0.0, -218.0, -921.0, -843.0].collect { |n| n / 548.0 }]
        z2 = [[203.0, 187.0, 78.0, 171.0, 125.0, 375.0, 218.0, 328.0, 281.0, 328.0, 156.0, 93.0, 281.0, 15.0, 93.0].collect { |n| n / 548.0 }]

        # row
        x3 = [[437.0,437.0,218.0,-31.0,-171.0,-62.0,-31.0,-15.0,-218.0,-93.0,250.0,0.0,-187.0,-328.0,-187.0].collect { |n| n / 548.0 }]
        y3 = [[-984.0, -1296.0, -2000.0, -1875.0, -1750.0, -1281.0, -1234.0, -953.0, -796.0, -46.0, -1640.0, -1125.0, -1156.0, -968.0, -1015.0].collect { |n| n / 548.0 }]
        z3 = [[281.0, 78.0, -31.0, 31.0, -62.0, -93.0, -140.0, -140.0, -140.0, -218.0, -62.0, -93.0, -46.0, 15.0, 31.0].collect { |n| n / 548.0 }]
...
# ]]
        ...
        xx = [Algorithm.array_string_to_array(x).collect { |n| n / 548.0 }]
        yy = [Algorithm.array_string_to_array(y).collect { |n| n / 548.0 }]
        zz = [Algorithm.array_string_to_array(z).collect { |n| n / 548.0 }]
