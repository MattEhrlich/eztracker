class IbeaconsController < ApplicationController
	...
	def index 
     ...
     #    error = []
        ...
        # tally +=1
        # p "Row"
        # error += [(Rep.rep_predict(@info.x_motion,@info.y_motion,@info.z_motion).to_i - 15).abs / 15.0]
        # p"15"
        ...
        # tally +=1
        # p "Curl"
        # error += [(Rep.rep_predict(@info.x_motion,@info.y_motion,@info.z_motion).to_i - 5).abs / 5.0]
        # p"5"
        # # Curl 9 
        ...
        # tally +=1
        # p "Curl"
        # error += [(Rep.rep_predict(@info.x_motion,@info.y_motion,@info.z_motion).to_i - 9).abs / 9.0]
        # p"9"
        # # Press 3
        ...
        # tally +=1
        # p "Shoulder Press"
        # error += [(Rep.rep_predict(@info.x_motion,@info.y_motion,@info.z_motion).to_i - 3).abs / 3.0]
        # p"3"
        # # Curl 11
        ...
        # tally +=1
        # p "Curl"
        # error += [(Rep.rep_predict(@info.x_motion,@info.y_motion,@info.z_motion).to_i - 11).abs / 11.0]
        # p"11"  
        #  # Row 5
        ...
        # tally +=1
        # p "Shoulder Press"
        # error += [(Rep.rep_predict(@info.x_motion,@info.y_motion,@info.z_motion).to_i - 10).abs / 10.0]
        # p"10"
        # # Row/Curl
        ...
        # tally +=1
        # p "Shoulder Press"
        # error += [(Rep.rep_predict(@info.x_motion,@info.y_motion,@info.z_motion).to_i - 12).abs / 12.0]
        # p"12"
        #  # Press 8
        ...
        # tally +=1
        # p "Shoulder Press"
        # error += [(Rep.rep_predict(@info.x_motion,@info.y_motion,@info.z_motion).to_i - 8).abs / 8.0]
        # p"8"
        #  # Press 2
        ...
        # tally +=1
        # p "Shoulder Press"
        # error += [(Rep.rep_predict(@info.x_motion,@info.y_motion,@info.z_motion).to_i - 2).abs / 2.0]
        # p"2"
        #  # Row 7
        ...
        # tally +=1
        # p "Row"
        # error += [(Rep.rep_predict(@info.x_motion,@info.y_motion,@info.z_motion).to_i - 7).abs / 7.0]
        # p"7"
        # # Row 15
        ...
        # tally +=1
        # p "Shoulder Press"
        # error += [(Rep.rep_predict(@info.x_motion,@info.y_motion,@info.z_motion).to_i - 4).abs / 4.0]
        # p"4"
        ...
        # tally +=1
        # p "Shoulder Press"
        # error += [(Rep.rep_predict(@info.x_motion,@info.y_motion,@info.z_motion).to_i - 6).abs / 6.0]
        # p"6"
        # # Curl 4
